 ...
 */
async function signIn(api: Api, session: Session, statusBar: StatusBar): Promise<void> {
...
async function signOut(api: Api, session: Session, statusBar: StatusBar): Promise<void> {
...
export async function activate(context: vscode.ExtensionContext): Promise<void> {
  ...
  context.subscriptions.push(
    ...
    vscode.commands.registerCommand('leetcodePractice.signIn', () => signIn(api, session, statusBar)),
    vscode.commands.registerCommand('leetcodePractice.signOut', () => signOut(api, session, statusBar)),
